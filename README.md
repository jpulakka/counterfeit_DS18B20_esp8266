...
[^1]: Example output in [results_for_aliexpress_probe.txt](https://github.com/jpulakka/counterfeit_DS18B20_esp8266/blob/master/results_for_aliexpress_probe.txt). My DS18B20s turned out to be "Family A3 (Clone)", which is "okay" among fakes.
